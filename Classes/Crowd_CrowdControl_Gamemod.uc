...
function int ProcessCode(String code, int id, int duration, out float timeRemaining)
{
    local Hat_Player ply;
    local Crowd_StatusEffect_Persistent effect;
    local float durationOverride;
    ...
    durationOverride = float(duration) / 1000.0f;
    ...
    switch (code)
    {
        ...
        case "make_invincible":
            ...
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Invincible', durationOverride));
            break;
        case "one_hit_hero":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Invincible') || ply.HasStatusEffect(class'Crowd_StatusEffect_OneHitHero')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_OneHitHero', durationOverride));
            break;
        case "increase_gravity":
            ...
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_DoubleGravity', durationOverride));
            break;
        case "decrease_gravity":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_DoubleGravity') || ply.HasStatusEffect(class'Crowd_StatusEffect_HalfGravity')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_HalfGravity', durationOverride));
            break;
        case "wind":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Wind')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Wind', durationOverride));
            break;
        case "spring_bounce":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_SpringBounce')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_SpringBounce', durationOverride));
            break;
        case "go_fast":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Fast') || ply.HasStatusEffect(class'Crowd_StatusEffect_Slow')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Fast', durationOverride));
            break;
        case "go_slow":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Fast') || ply.HasStatusEffect(class'Crowd_StatusEffect_Slow')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Slow', durationOverride));
            break;
        case "time_stop":
            ...
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_TimeStop', durationOverride));
            break;
        case "dweller_sphere":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_DwellerSphere') || ply.IsFoxMaskActive) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_DwellerSphere', durationOverride));
            break;
        case "ice_statue":
            ...
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_IceStatue', durationOverride));
            break;
        case "shrink":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Shrink') || ply.HasStatusEffect(class'Crowd_StatusEffect_Grow')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Shrink', durationOverride));
            break;
        case "grow":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Shrink') || ply.HasStatusEffect(class'Crowd_StatusEffect_Grow')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Grow', durationOverride));
            break;
        case "make_invisible":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_MakeInvisible')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_MakeInvisible', durationOverride));
            break;
        case "babysit":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_BabyMode') || ply.IsCarryingItem()) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_BabyMode', durationOverride));
            break;
        case "give_triple_jump":
            ...
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_TripleJump', durationOverride));
            break;
        case "disable_jump":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_TripleJump') || ply.HasStatusEffect(class'Crowd_StatusEffect_NoJump') || ply.HasStatusEffect(class'Crowd_StatusEffect_NoDoubleJump')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_NoJump', durationOverride));
            break;
        case "disable_double_jump":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_TripleJump') || ply.HasStatusEffect(class'Crowd_StatusEffect_NoJump') || ply.HasStatusEffect(class'Crowd_StatusEffect_NoDoubleJump')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_NoDoubleJump', durationOverride));
            break;
        case "disable_weapon":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_NoWeapon') || ply.GetWeapon() == None) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_NoWeapon', durationOverride));
            break;
        case "random_filter":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_RandomFilter')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_RandomFilter', durationOverride));
            break;
        case "parade_owls":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Parade')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Parade', durationOverride));
            break;
        case "annoyance":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_Annoyance')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_Annoyance', durationOverride));
            break;
        case "lose_hat":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_LoseHat')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_LoseHat', durationOverride));
            break;
        case "first_person":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_FirstPerson')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_FirstPerson', durationOverride));
            break;
        case "reverse_controls":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_ReverseControls')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_ReverseControls', durationOverride));
            break;
        case "mirror_mode":
            if(ply.HasStatusEffect(class'Crowd_StatusEffect_MirrorMode')) return 3;
            effect = Crowd_StatusEffect_Persistent(ply.giveStatusEffect(class'Crowd_StatusEffect_MirrorMode', durationOverride));
            break;
        case "give_timepiece":
...
event OnModUnloaded()
{
    ...
    foreach Hat_PawnCombat(GetALocalPlayerController().Pawn).StatusEffects(fx)
    {
        if (Crowd_StatusEffect_Persistent(fx) != None)
        {
            pfx = Crowd_StatusEffect_Persistent(fx);
		    Hat_PawnCombat(GetALocalPlayerController().Pawn).RemoveStatusEffect(pfx.Class, false);
        }
    }
...
function bool UnlockRandomTimePiece(Hat_ChapterInfo ci, bool Unlock)
{
    ...
    if (Unlock)
    {
        class'Crowd_CrowdControl_Gamemod'.static.DebugLog("Unlocked Timepiece: " $ AvailableActs[rand].Hourglass, true);
    ...
    {
        class'Crowd_CrowdControl_Gamemod'.static.DebugLog("Removed Timepiece: " $ AvailableActs[rand].Hourglass, true);
...
{
    local Array<class<Object>> SkinClassesObj;
    local Array<class<Hat_Collectible_Skin>> SkinClasses;
    local class<Hat_Collectible_Skin> currentSkin;
    local class<Hat_Collectible_Skin> skin;
    local int i;
    currentSkin = GetSkin();
    SkinClassesObj = class'Hat_ClassHelper'.static.GetAllScriptClasses("Hat_Collectible_Skin");

    for (i = 0; i < SkinClassesObj.Length; i++)
    {
        skin = class<Hat_Collectible_Skin>(SkinClassesObj[i]);
        if(skin == None) continue;
        if(skin == class'Hat_Collectible_Skin') continue;
        if(skin == class'Crowd_Random_Costume') continue;
        if(skin == currentSkin) continue;
        if (!skin.static.IsOnlineItemAvailable()) continue;
        // if (mod.unlockedCostumesOnly == 0 && Owner.GetLoadout().BackpackHasSkin(Owner.GetLoadout().MakeLoadoutItem(skin, class'Hat_CosmeticItemQualityInfo_SearchAny')) == INDEX_NONE) continue;		
        if (skin.static.GetLocalizedItemName() == "") continue;

        SkinClasses.AddItem(skin);
    }
    
    skin = SkinClasses[rand(SkinClasses.Length)];

	Hat_PlayerController(GetALocalPlayerController()).GetLoadout().RemoveBackpack(class'Hat_Loadout'.static.MakeLoadoutItem(class'Crowd_Random_Costume'), true);

    SaveSkin(skin);

	Hat_PlayerController(GetALocalPlayerController()).GetLoadout().AddBackpack(class'Hat_Loadout'.static.MakeLoadoutItem(class'Crowd_Random_Costume'), true);
    Hat_PlayerController(GetALocalPlayerController()).GetLoadout().EquipLoadoutClass(class'Crowd_Random_Costume');
}

static function SaveSkin(class<Hat_Collectible_Skin> SkinClass)
{
	WipeSkin("crowdcontrolskin");
	class'Hat_SaveBitHelper'.static.SetLevelBits(locs("crowdskin+"$SkinClass.Name), 1, "crowdcontrolskin");
}

static function WipeSkin(string SkinKey)
{
	local Hat_SaveGame_Base s;
	local int i,ii;
	local Array<String> arr;
	...
	i = s.GetLevelSaveInfoIndex(class'Hat_SaveBitHelper'.static.GetCorrectedMapFilename(SkinKey), true);
	if (i < 0) return;
	for (ii = 0; ii < s.LevelSaveInfo[i].LevelBits.Length; ii++)
	{
		arr = SplitString(s.LevelSaveInfo[i].LevelBits[ii].Id, "+", true);
...
static function class<Hat_Collectible_Skin> GetSkin()
{
	local Hat_SaveGame_Base s;
	local int i,ii;
    local Array<String> arr;
	...
	i = s.GetLevelSaveInfoIndex(class'Hat_SaveBitHelper'.static.GetCorrectedMapFilename("crowdcontrolskin"), true);
	if (i < 0) return None;

	for (ii = 0; ii < s.LevelSaveInfo[i].LevelBits.Length; ii++)
	{
		arr = SplitString(s.LevelSaveInfo[i].LevelBits[ii].Id, "+", true);
		if (arr[0] ~= ("crowdskin") && s.LevelSaveInfo[i].LevelBits[ii].Bits > 0)
		{
			SkinClass = class<Hat_Collectible_Skin>(class'Hat_ClassHelper'.static.GetScriptClass(arr[1]));
            return SkinClass;
		}
    }
    return None;
...
static function DebugLog(String s, bool forceLog = false)
{
    if (Debug || forceLog) class'WorldInfo'.static.GetWorldInfo().Game.Broadcast(class'WorldInfo'.static.GetWorldInfo(), s);
}
